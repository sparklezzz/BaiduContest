...
package baiducontest.vectorizer.tfidf;
...
import baiducontest.vectorizer.term.TermDocumentCountMapper;
import baiducontest.vectorizer.term.TermDocumentCountReducer;
