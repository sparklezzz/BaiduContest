...
package baiducontest.vectorizer.common;
...
public final class PartialVectorMerger {
  ...
  /**
   * Merge all the partial {@link baiducontest.math.RandomAccessSparseVector}s into the complete Document
   * {@link baiducontest.math.RandomAccessSparseVector}
   * 
