...
import baiducontest.vectorizer.collocations.llr.CollocDriver;
import baiducontest.vectorizer.common.PartialVectorMerger;
import baiducontest.vectorizer.term.TFPartialVectorReducer;
import baiducontest.vectorizer.term.TermCountCombiner;
import baiducontest.vectorizer.term.TermCountMapper;
import baiducontest.vectorizer.term.TermCountReducer;
...
public final class DictionaryVectorizer implements Vectorizer{
   ...
   * @param output
   *          output directory where {@link baiducontest.math.RandomAccessSparseVector}'s of the document
   *          are generated
