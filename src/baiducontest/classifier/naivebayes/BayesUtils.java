package baiducontest.classifier.naivebayes;
...
import baiducontest.classifier.naivebayes.training.ThetaMapper;
import baiducontest.classifier.naivebayes.training.TrainNaiveBayesJob;
...
import baiducontest.math.SparseMatrix;
...
public final class BayesUtils {
	...
	public static NaiveBayesModel readModelFromDir(Path base, Configuration conf) {
		...
		return new NaiveBayesModel(scoresPerLabelAndFeature, scoresPerFeature,
				scoresPerLabel, perlabelThetaNormalizer, alphaI);
	}
